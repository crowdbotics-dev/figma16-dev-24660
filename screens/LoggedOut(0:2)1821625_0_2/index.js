  ...
  render = () => (
    ...
    >
        ...
        <View style={styles.View_0_23}>
          <View style={styles.View_0_24}>
            ...
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/ba23251c-5d0f-458c-8694-f50049420a89"
              }}
          ...
          <View style={styles.View_0_28}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/1777849d-48db-4ce9-ad66-0b7cfbdf7bb4"
              }}
          ...
          <View style={styles.View_0_33}>
            <ImageBackground
              source={{
                uri:
                  "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/b33aca3a-4d45-49c3-9c4b-e6cc1838a62e"
              }}
      ...
      <ImageBackground
        source={{
          uri:
            "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/c7e04576-6142-41da-966d-fbfb9bf4221d"
        }}
      ...
      <View style={styles.View_0_119}>
        ...
        <ImageBackground
          source={{
            uri:
              "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/716bd9cf-e1b5-455c-884e-9bba517bd836"
          }}
        ...
        <ImageBackground
          source={{
            uri:
              "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/c0025290-0811-44d3-b614-cf1f6fa3320e"
          }}
      ...
      <View style={styles.View_0_125}>
        ...
        <ImageBackground
          source={{
            uri:
              "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/49cae934-3a4e-4c80-87a4-054e784b1b5b"
          }}
